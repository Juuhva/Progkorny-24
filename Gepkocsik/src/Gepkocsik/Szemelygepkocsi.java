...
public class Szemelygepkocsi extends Gepkocsi{
    public Szemelygepkocsi(String rendszam, int evjarat, int eredetiAr, Allapot allapot,
                           int szallithatoSzemelyekSzama, boolean vanEVonohorog,
                           Klima klima) throws RuntimeException {
    ...
    public Szemelygepkocsi(String rendszam, int evjarat, int eredetiAr, int szallithatoSzemelyekSzama,
                           boolean vanEVonohorog) throws RuntimeException {
        this(rendszam, evjarat, eredetiAr, Allapot.MEGKIMELT,
                szallithatoSzemelyekSzama, vanEVonohorog, Klima.DIGITALIS);
    }
